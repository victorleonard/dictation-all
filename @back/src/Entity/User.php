...
use App\Controller\UserMeTimeController;
use App\Controller\UserMeVerbController;
use App\Controller\UserMeVerbsController;
...
#[ApiResource(
    operations: [
        ...
        new GetCollection(
            name: 'getMeVerbs',
            uriTemplate: '/users/me/verbs',
            controller: UserMeVerbsController::class,
            read: false,
            write: false,
            validate: false
        ),
        ...
        new Put(
            name: 'newLearnedTime',
            uriTemplate: '/users/me/time/{id}',
            controller: UserMeTimeController::class,
            read: false,
            write: false,
            validate: false
        ),
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\ManyToMany(targetEntity: Time::class, mappedBy: 'user')]
